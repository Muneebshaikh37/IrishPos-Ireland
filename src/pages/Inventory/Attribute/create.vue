      ...
      <div class="intro-y box p-8">
        <div class="grid grid-cols-12 gap-6">
          <div class="col-span-6">
            ...
            <FormInput v-model="createFormData.name" id="attr-name" type="text" :class="{ 'border-red-500': form.invalid('name') || form.invalid('name_en') || validationErrors.name }" :placeholder="$t('category.enterName')" />
          ...
          <div class="col-span-6">
            ...
            <FormInput v-model="createFormData.key_name" id="key_name" type="text" :placeholder="$t('category.autoGeneratedFromName')" />
