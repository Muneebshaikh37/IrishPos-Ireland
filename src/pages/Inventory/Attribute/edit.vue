...
const fetchAttribute = async () => {
  try {
    ...
    if (result.success) {
      ...
      createFormData.value.name_en = data.name_en || "";
      createFormData.value.name_ar = data.name_ar || "";
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-6">
            ...
            <div class="flex items-center  ">
              <FormInput v-model="createFormData.name_en" id="name_en" type="text" class="w-full"
                         :placeholder="$t('category.enterEnglishName')"
                         :class="{ 'border-red-500': form.invalid('name_en') || validationErrors.name_en }"/>
            </div>
          ...
          <div class="col-span-6">
            ...
            <div class="flex items-center  ">
              <FormInput v-model="createFormData.name_ar" id="name_ar" type="text" class="w-full"
                         :placeholder="$t('category.enterArabicName')"
                         :class="{ 'border-red-500': form.invalid('name_ar') || validationErrors.name_ar }"/>
            </div>
          ...
          <div class="col-span-6">
            ...
            <FormInput v-model="createFormData.key_name" id="key_name" type="text" class="w-full" :placeholder="$t('category.autoGeneratedFromEnglish')" />
